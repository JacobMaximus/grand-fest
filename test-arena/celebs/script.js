...
//   setTimeout(updateImages, 20000); // Run every 20s (full spin cycle)
// }
...
const images = [
  ...
  function updateImages() {
    ...
    setTimeout(updateImages, 8750); // Run every 20s (full spin cycle)
  }
  
  // Start Image Update Loop
//   setTimeout(updateImages, 20000);
setTimeout(updateImages, 8750); // Runs every 10s (twice as fast)
